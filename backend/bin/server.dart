...
import 'package:backend/infrastructure/repositories/inventory_variant_warehouse_repository_impl.dart';
...
import 'package:backend/infrastructure/repositories/employee_contract_repository_impl.dart';
...
void main(List<String> args) async {
  ...
  final inventoryVariantWarehouseRepository = InventoryVariantWarehouseRepositoryImpl(db);
  ...
  final employeeContractRepository = EmployeeContractRepositoryImpl(db);
  ...
  final dashboardRoutes = DashboardRoutes(
    ...
    quotationRepository,
    inventoryVariantWarehouseRepository,
