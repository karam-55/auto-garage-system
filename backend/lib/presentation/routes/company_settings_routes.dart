...
class CompanySettingsRoutes {
  ...
  Router get router {
    ...
    router.get('/api/company/settings', _authMiddleware.authenticate()(_authMiddleware.requireRole(Role.OWNER)(_getSettings)));

    // PATCH /api/company/settings - Update company settings
    router.patch('/api/company/settings', _authMiddleware.authenticate()(_authMiddleware.requireRole(Role.OWNER)(_updateSettings)));

    // POST /api/company/upload-logo - Upload company logo
    router.post('/api/company/upload-logo', _authMiddleware.authenticate()(_authMiddleware.requireRole(Role.OWNER)(_uploadLogo)));
